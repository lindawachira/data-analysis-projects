...
72% of customers didn't respond to any marketing campaign — meaning the majority of the customer base was essentially being marketed to and ignored. One campaign did work broadly, reaching 311 customers, proving the approach can work — it just wasn't being applied consistently.
...
One product category brought in the most revenue ($619K), and a second brought in the highest sales volume — but they were being marketed separately, missing an obvious opportunity to sell more per order. Meanwhile, two other categories were barely selling at all ($55K and $53K).
...
Older, more highly educated, higher-income customers spent more per order (over $250 on average) and responded to campaigns at more than double the typical rate — but were getting the same generic treatment as everyone else.
